...
export function valida(input) {
  ...
  if (input.validity.valid) {
    input.parentElement.classList.remove("input-container--invalid"); //esta clase está en una libreria externa
...
export function validaAreaDeTexto(textarea) {
  ...
  if (valorDeAreaDeTexto === "") { //si la variable esta vacía
    textarea.parentElement.classList.remove("input-container--invalid"); //quitar esta clase al elemento principal
